...
public class Seat1 extends javax.swing.JFrame {
    ...
    private class ButtonHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            dateTomorrow = c.getTime();
            String dateTime = (String)sdf.format(jDateChooser1.getDate());
            String dateTimeCurrent = (String)sdf.format(dateCurrent);
            String dateTimeTomorrow = (String)sdf.format(dateTomorrow);
            ...
            if (dateTime.equals(dateTimeTomorrow)){
            switch(time){
                case "10:00" ->  {
                    for(int i=0; i<seatStrLen3/3; i++){
                        int j = i*3;
                        seatTemp[i] = seat3.substring(j,j+3);
                        seat = seat.replace(seatTemp[i], "");
                    }
                    count = count - count3;
                }
                case "16:00" ->  {
                    for(int i=0; i<seatStrLen4/3; i++){
                        int j = i*3;
                        seatTemp[i] = seat4.substring(j,j+3);
                        seat = seat.replace(seatTemp[i], "");
                    }
                    count = count - count4;
                }
            ...
            if (dateTime.equals(dateTimeTomorrow)){
                ...
                case "10:00" : {
                    count3 = count3 + count;
                    seat3 = seat3 + seat;
                    seatStrLen3 = seat3.length();
                    break;
                }
                case "16:00" : {
                    count4 = count4 + count;
                    seat4 = seat4 + seat;
                    seatStrLen4 = seat4.length();
                    break;
                }
            }
            }
